...
<img className="  logoAct" src={logo} alt="sada" />
                    ...
                    <form >
                        ...
                        <div className="mb-2 mt-3">
                            ...
                            <input  type="name" required minLength="2" maxLength="18" placeholder="Ahmed" className="form-control" />
                             <p style={{color:"red", fontWeight:"bold"}} className="warning"></p>
                        </div>
                        <div className="mb-2">
                            <label htmlFor="lName">الكنية</label>
                            <input  type="lName" required minLength="2" maxLength="18" placeholder="الكنية" className="form-control" />
                             <p style={{color:"red", fontWeight:"bold"}} className="warning"></p>
                        </div>
                        <div className="mb-2">
